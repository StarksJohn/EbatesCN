...
import *as PersonalPageApi from '../../NetWork/API/PersonalPageApi'

const initialState = new InitialState()
    .setIn(['ApiName'], PersonalPageApi.PersonalPageApi.ApiName)
    .setIn(['isRenderRefreshControl'], false)
    .setIn(['isRenderFooterView'], false);


export default function PersonalPageReducer(state = initialState, action) {
