 ...
 * AllCouponPageSortListReducer
 * 全部优惠页 sort 下拉列表的 reducer
 */
import {
    ListView,
} from 'react-native';
...
/*搜索结果页 优惠 列表的 特殊状态*/
    .setIn(['ApiName'], AllCouponPageApi.AllCouponPageSortDropDownListApi.ApiName)
    .setIn(['isRenderRefreshControl'], false)

export default function AllCouponPageSortListReducer(state = initialState, action) {
